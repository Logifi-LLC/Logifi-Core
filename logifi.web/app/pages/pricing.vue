<template>
  ...
  <div class="min-h-screen bg-[#e4e8e7] font-quicksand text-gray-900 overflow-x-hidden dark:bg-[#e4e8e7] dark:text-gray-900">
    ...
    <main class="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
      ...
      <div class="relative overflow-hidden rounded-[28px] border border-white/15 bg-white/10 backdrop-blur-md shadow-[0_0_42px_-12px_rgba(59,130,246,0.24),0_0_56px_-18px_rgba(37,99,235,0.14)] p-6 sm:p-8 lg:px-10 lg:pt-10 lg:pb-8 space-y-6">
        <div>
        ...
        <p class="text-lg text-gray-800 leading-relaxed dark:text-gray-800">
          ...
          <NuxtLink to="/terms" class="text-blue-600 font-bold hover:underline dark:text-blue-600">Terms</NuxtLink>.
        </p>
