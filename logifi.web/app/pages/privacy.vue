  ...
  >
    ...
    <main :class="['pb-16 px-4 sm:px-6 lg:px-8', isFromLanding ? 'pt-32' : 'pt-24']">
      ...
      >
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">1. Who We Are</h2>
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">2. What We Collect</h2>
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">3. How We Use It</h2>
          <p :class="['leading-relaxed', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">4. Aggregated and De-Identified Data</h2>
          <p :class="['leading-relaxed mb-3', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
            We may create <strong :class="isFromLanding ? 'text-gray-100' : ''">aggregated and de-identified</strong> data from logbook and usage data (e.g., flight hours, aircraft types, routes, dates, patterns). This data <strong :class="isFromLanding ? 'text-gray-100' : ''">does not include names, email addresses, or other direct identifiers</strong> and is not reasonably capable of identifying you.
          </p>
          <p :class="['leading-relaxed', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">5. Who We Share Data With</h2>
          <p :class="['leading-relaxed', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">6. Optional airline schedule connection</h2>
          <p :class="['leading-relaxed mb-3', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">7. Retention</h2>
          <p :class="['leading-relaxed', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">8. Security</h2>
          <p :class="['leading-relaxed', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">9. Your Rights</h2>
          <p :class="['leading-relaxed mb-3', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">10. Cookies and Similar Technologies</h2>
          <p :class="['leading-relaxed mb-3', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">12. Contact</h2>
          <p :class="['leading-relaxed', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
