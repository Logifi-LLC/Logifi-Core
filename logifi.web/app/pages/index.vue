...
const handleAuthSuccess = () => {
  // In Core, after auth we send users to the main app dashboard
...
const features = [
  ...
  {
    title: 'FAA Compliant',
    description: 'Rest easy knowing your records meet all AC 120-78B requirements. Digital signatures coming soon.',
