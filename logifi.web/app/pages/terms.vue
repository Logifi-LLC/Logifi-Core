  ...
  >
    ...
    <main :class="['pb-16 px-4 sm:px-6 lg:px-8', isFromLanding ? 'pt-32' : 'pt-24']">
      ...
      >
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">1. Acceptance</h2>
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">2. Description of Service</h2>
          <p :class="['leading-relaxed', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">3. Account and Eligibility</h2>
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">4. Use of Service</h2>
          <p :class="['leading-relaxed', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          <h2 :class="['text-xl font-bold font-quicksand mb-3', isFromLanding ? 'text-gray-100' : 'text-gray-900 dark:text-white']">5. Data and Analytics</h2>
          <p :class="['leading-relaxed', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
        ...
        <section class="mb-10">
          ...
          <p :class="['leading-relaxed mb-3', isFromLanding ? 'text-gray-300' : 'text-gray-700 dark:text-gray-300']">
            ...
            <strong :class="isFromLanding ? 'text-gray-100' : ''">logbook record-keeping only</strong>
